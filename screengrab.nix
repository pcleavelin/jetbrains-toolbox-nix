# Script originally from https://unix.stackexchange.com/a/346800
{ imagemagick, xclip }:
''
function help_and_exit {
    ...
    cat <<-EOF
    Usage: screengrab [-h|-s] [<screenshots_base_folder>]
...
${imagemagick}/bin/import ''${params} ''${file_path}
${xclip}/bin/xclip -selection clipboard -target image/png -i < ''${file_path}
''
